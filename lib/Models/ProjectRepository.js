...
(function() {
  ...
  ProjectRepository = (function(_super) {
    ...
    ProjectRepository.prototype.showBranch = function(projectId, branchId, fn) {
      ...
      this.debug("Projects::showBranch()");
    ...
    ProjectRepository.prototype.addBranch = function(projectId, params, fn) {
      if (fn == null) {
        fn = null;
      }
      this.debug("Projects::addBranch()");
      if (params.branch_name && params.ref) {
        return this.post("projects/" + (Utils.parseProjectId(projectId)) + "/repository/branches", params, (function(_this) {
          return function(data) {
            if (fn) {
              return fn(data);
            }
